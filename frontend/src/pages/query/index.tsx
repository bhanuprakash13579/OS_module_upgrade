...
export default function QueryModule() {
  ...
  return (
    <div className="flex min-h-screen w-full bg-slate-50 text-slate-800">
      ...
      <aside className={`${isCollapsed ? 'w-16' : 'w-64'} flex flex-col h-screen sticky top-0 bg-slate-900 border-r border-slate-700 shadow-xl shadow-slate-900/20 transition-[width] duration-200 print:hidden shrink-0 z-50`}>
